...
final class Configuration implements ConfigurationInterface
{
    ...
    {
        $treeBuilder = new TreeBuilder('opendxp');
        ...
        $rootNode
            ->children()
                ->arrayNode('bundles')
                    ->info('Define parameters for OpenDxp Bundle Locator')
                    ->addDefaultsIfNotSet()
                    ->children()
                        ...
                        ->arrayNode('debugging')
                            ...
                            ->children()
                                ->scalarNode('parameter')
                                    ->defaultValue('opendxp_debug_translations')
                                ->end()
                            ->end()
                        ->end()
        ...
        $storageNode = ConfigurationHelper::addConfigLocationWithWriteTargetNodes($rootNode, [
            ...
            'document_types' => OPENDXP_CONFIGURATION_DIRECTORY . '/document_types',
            'predefined_properties' => OPENDXP_CONFIGURATION_DIRECTORY . '/predefined_properties',
            'predefined_asset_metadata' => OPENDXP_CONFIGURATION_DIRECTORY . '/predefined_asset_metadata',
            'perspectives' => OPENDXP_CONFIGURATION_DIRECTORY . '/perspectives',
            'custom_views' => OPENDXP_CONFIGURATION_DIRECTORY . '/custom_views',
            'object_custom_layouts' => OPENDXP_CONFIGURATION_DIRECTORY . '/object_custom_layouts',
        ]);

        ConfigurationHelper::addConfigLocationTargetNode(
            $storageNode,
            'system_settings',
            OPENDXP_CONFIGURATION_DIRECTORY . '/system_settings',
        ...
        ConfigurationHelper::addConfigLocationTargetNode(
            $storageNode,
            'select_options',
            OPENDXP_CONFIGURATION_DIRECTORY . '/select_options',
            [LocationAwareConfigRepository::READ_TARGET]
        );
                        ...
                        ->prototype('array')
                            ->children()
                                ...
                                ->arrayNode('supports')
                                    ...
                                    ->example(['\OpenDxp\Model\DataObject\Product'])
                                ->end()
                                ->arrayNode('support_strategy')
                                    ...
                                    ->example([
                                        ...
                                        'arguments' => [
                                            ...
                                            'subject.getProductType() == "article" and is_fully_authenticated() and "ROLE_OPENDXP_ADMIN" in roles',
                                        ],
                                    ])
                                ->end()
                                ...
                                ->arrayNode('places')
                                    ->prototype('array')
                                        ->children()
                                            ->scalarNode('label')->info('Nice name which will be used in the OpenDxp backend.')->end()
                                            ->scalarNode('title')->info('Title/tooltip for this place when it is displayed in the header of the OpenDxp element detail view in the backend.')->defaultValue('')->end()
                                            ->scalarNode('color')->info('Color of the place which will be used in the OpenDxp backend.')->defaultValue('#bfdadc')->end()
                                            ...
                                            ->booleanNode('visibleInHeader')->info('If set to false, the place will be hidden in the header of the OpenDxp element detail view in the backend.')->defaultTrue()->end()
                                            ...
                                            ->arrayNode('permissions')
                                                ->prototype('array')
                                                    ->children()
                                                        ...
                                                        ->booleanNode('save')->info('save permission as it can be configured in OpenDxp workplaces')->end()
                                                        ->booleanNode('publish')->info('publish permission as it can be configured in OpenDxp workplaces')->end()
                                                        ->booleanNode('unpublish')->info('unpublish permission as it can be configured in OpenDxp workplaces')->end()
                                                        ->booleanNode('delete')->info('delete permission as it can be configured in OpenDxp workplaces')->end()
                                                        ->booleanNode('rename')->info('rename permission as it can be configured in OpenDxp workplaces')->end()
                                                        ->booleanNode('view')->info('view permission as it can be configured in OpenDxp workplaces')->end()
                                                        ->booleanNode('settings')->info('settings permission as it can be configured in OpenDxp workplaces')->end()
                                                        ->booleanNode('versions')->info('versions permission as it can be configured in OpenDxp workplaces')->end()
                                                        ->booleanNode('properties')->info('properties permission as it can be configured in OpenDxp workplaces')->end()
                                    ...
                                    ->example([
                                        'places' => [
                                            'closed' => [
                                                ...
                                                'permissions' => [
                                                    [
                                                        'condition' => "is_fully_authenticated() and 'ROLE_OPENDXP_ADMIN' in roles",
                                                        'modify' => false,
                                                    ],
                                                    [
                                                        'modify' => false,
                                ...
                                ->arrayNode('transitions')
                                    ...
                                    ->prototype('array')
                                        ->children()
                                            ...
                                            ->arrayNode('options')
                                                ->children()
                                                    ->scalarNode('label')->info('Nice name for the OpenDxp backend.')->end()
                                                    ->arrayNode('notes')
                                                        ->children()
                                                                ...
                                                                ->prototype('array')
                                                                    ->children()
                                                                        ...
                                                                        ->arrayNode('fieldTypeSettings')
                                                                             ->prototype('variable')->end()
                                                                             ->info('Will be passed to the underlying OpenDxp data object field type. Can be used to configure the options of a select box for example.')
                                                                        ->end()
                                                                    ->end()
                                                                ->end()
                                                        ...
                                                        ->prototype('array')
                                                            ->children()
                                                                ...
                                                                ->arrayNode('channelType')
                                                                    ->requiresAtLeastOneElement()
                                                                    ->enumPrototype()
                                                                        ->values([NotificationSubscriber::NOTIFICATION_CHANNEL_MAIL, NotificationSubscriber::NOTIFICATION_CHANNEL_OPENDXP_NOTIFICATION])
                                                                        ->cannotBeEmpty()
                                                                        ->defaultValue(NotificationSubscriber::NOTIFICATION_CHANNEL_MAIL)
                                                                    ->end()
                                                                    ->info('Define which channel notification should be sent to, possible values "' . NotificationSubscriber::NOTIFICATION_CHANNEL_MAIL . '" and "' . NotificationSubscriber::NOTIFICATION_CHANNEL_OPENDXP_NOTIFICATION . '", default value is "' . NotificationSubscriber::NOTIFICATION_CHANNEL_MAIL . '".')
                                                                ...
                                                                ->scalarNode('mailPath')
                                                                    ...
                                                                    ->info('Path to mail source - either Symfony path to template or fullpath to OpenDxp document. Optional use ' . NotificationEmailService::MAIL_PATH_LANGUAGE_PLACEHOLDER . ' as placeholder for language.')
                                                                ->end()
                                                            ->end()
                                                        ->end()
                                                    ->end()
            ...
            ->children()
                ...
                ->children()
                    ...
                    ->booleanNode('tag_fallback_document')
                        ->info('Whether to tag the response with the document found in the request (DynamicRouter::CONTENT_KEY) when it is only a fallback, i.e. it was not resolved by the matched route itself but is merely the nearest document by path. Default: true.')
                        ->defaultTrue()
                    ->end()
                    ->arrayNode('elements')
                        ...
                        ->children()
                            ->arrayNode('documents')
                                ...
                                ->children()
                                    ...
                                    ->booleanNode('tag_list')
                                        ->info('Also tag/invalidate "document_list".')
                                        ->defaultTrue()
                                    ->end()
                                ->end()
                            ->end()
                            ->arrayNode('data_objects')
                                ...
                                ->children()
                                    ->booleanNode('enabled')->defaultTrue()->end()
                                    ->booleanNode('tag_list')
                                        ->info('Also tag/invalidate "data_object_class_{className}".')
                                        ->defaultTrue()
                                    ->end()
                                ->end()
                            ->end()
                            ->arrayNode('assets')
                                ...
                                ->children()
                                    ->booleanNode('enabled')->defaultTrue()->end()
                                    ->booleanNode('tag_list')
                                        ->info('Also tag/invalidate "asset_list".')
                                        ->defaultTrue()
                                    ->end()
                                ->end()
                            ->end()
