...
namespace OpenDxp\Bundle\SimpleBackendSearchBundle\Model\Search\Backend;

use Doctrine\DBAL\Exception\DeadlockException;
use Exception;
use ForceUTF8\Encoding;
use OpenDxp;
use OpenDxp\Bundle\SimpleBackendSearchBundle\Event\Model\SearchBackendEvent;
use OpenDxp\Bundle\SimpleBackendSearchBundle\Event\SearchBackendEvents;
use OpenDxp\Bundle\SimpleBackendSearchBundle\Model\Search\Backend\Data\Dao;
...
class Data extends AbstractModel
{
    ...
    public function setDataFromElement(Element\ElementInterface $element): static
    {
        ...
        if ($element instanceof Document) {
            ...
            if (is_array($elementMetadata)) {
                foreach ($elementMetadata as $md) {
                    try {
                        ...
                        /** @var \OpenDxp\Model\Asset\MetaData\ClassDefinition\Data\Data $instance */
            ...
            if ($element instanceof Asset\Document &&\OpenDxp\Document::isAvailable()) {
                if (\OpenDxp\Document::isFileTypeSupported($element->getFilename())) {
                    try {
