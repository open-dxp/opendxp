...
namespace OpenDxp\Bundle\StaticRoutesBundle\Routing\Staticroute;
 ...
 * @internal
 *
 * A custom router implementation handling OpenDXP static routes.
 */
    ...
    protected function doMatch(string $pathinfo, ?Request $request = null): array
    {
        ...
        foreach ($this->getStaticRoutes() as $route) {
            ...
            if ($routeParams = $route->match($pathinfo, $params)) {
                ...
                // OpenDxp_Controller_Action_Frontend::getRenderScript()
                // to determine if a call to an action was made through a staticroute or not
                // more on that infos see OpenDxp_Controller_Action_Frontend::getRenderScript()
