...
namespace OpenDxp\Bundle\UuidBundle\Model\Tool;

use Exception;
use OpenDxp;
use OpenDxp\Bundle\UuidBundle\Model\Tool\UUID\Dao;
use OpenDxp\Model;
...
final class UUID extends Model\AbstractModel
{
    ...
    {
        $instanceIdentifier = OpenDxp::getKernel()->getContainer()->getParameter('opendxp_uuid.instance_identifier');
