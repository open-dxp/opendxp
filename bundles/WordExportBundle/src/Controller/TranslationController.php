...
namespace OpenDxp\Bundle\WordExportBundle\Controller;
...
class TranslationController extends UserAwareController
{
        ...
        foreach ($data as $el) {
            try {
                ...
                if ($element instanceof PageSnippet) {
                    ...
                    // we need to set the parameter "opendxp_admin" here to be able to render unpublished documents
                    $html = Service::render($element, [], false, ['opendxp_admin' => true]);
    ...
    public function wordExportDownloadAction(Request $request): Response
    {
        ...
        $content =
            ...
            "<head>\n" .
            '<style type="text/css">' . "\n" .
            file_get_contents(OPENDXP_WEB_ROOT . '/bundles/opendxpwordexport/css/word-export.css') .
            "</style>\n" .
            "</head>\n\n" .
            "<body>\n" .
            $content .
    ...
    private function getExportFilePath(string $id, bool $checkExistence = true): string
    {
        ...
        $exportFile = OPENDXP_SYSTEM_TEMP_DIRECTORY . DIRECTORY_SEPARATOR . $id . '.html';
