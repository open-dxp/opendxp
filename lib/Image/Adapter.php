...
abstract class Adapter implements AdapterInterface
{
    ...
    /**
     * @todo: duplication found? (opendxp/lib/OpenDxp/Document/Adapter.php::removeTmpFiles)
     */
    ...
    {
        $tmpFile = OPENDXP_SYSTEM_TEMP_DIRECTORY . '/' . uniqid() . '_opendxp_image_tmp_file.png';
