...
abstract class AbstractModel implements ModelInterface
{
    ...
    /**
     * @var \OpenDxp\Model\Dao\AbstractDao|null
     */
    protected $dao;
    ...
    public function initDao(?string $key = null, bool $forceDetection = false): void
    {
        ...
        if (!$forceDetection && array_key_exists($cacheKey, self::$daoClassCache)) {
            ...
            $dao = self::$daoClassMap[$myClass] ?? self::locateDaoClass($myClass);
        } else {
    ...
    {
        $forbiddenClassNames = ['OpenDxp\\Resource'];
    ...
    public function __call(string $method, array $args)
    {
        ...
        if (!is_callable([$this, $method])) {
            throw new BadMethodCallException("Unable to call private/protected method '" . $method . "' on object " . static::class);
        }
        ...
        throw new BadMethodCallException('Call to undefined method ' . $method . ' in class ' . static::class);
    }
    ...
    {
        return OpenDxp::getContainer()->get('opendxp.model.factory');
    }
