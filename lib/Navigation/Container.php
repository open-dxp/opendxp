...
class Container implements RecursiveIterator, Countable
{
    ...
    public function addPage($page): static
    {
        ...
        if (is_array($page)) {
            ...
            throw new Exception('Invalid argument: $page must be an instance of \OpenDxp\Navigation\Page or an array');
        }
     ...
     *
     * @return mixed  OpenDxp\Navigation|array|null    matching page, array of pages
     *                                              or null
     *
