...
final class Config extends Model\AbstractModel
{
    ...
    {
        $customPreviewImageThumbnail = \OpenDxp\Config::getSystemConfiguration('assets')['preview_image_thumbnail'];
        $thumbnail = null;
        ...
        if (!$thumbnail) {
            ...
            $thumbnail->addItem('setBackgroundImage', [
                'path' => '/bundles/opendxpadmin/img/tree-preview-transparent-background.png',
                'mode' => 'asTexture',
            ]);
    ...
    {
        return \OpenDxp\Config::getSystemConfiguration('assets')['image']['thumbnails']['auto_formats'];
    }
