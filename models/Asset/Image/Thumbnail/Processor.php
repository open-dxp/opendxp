...
namespace OpenDxp\Model\Asset\Image\Thumbnail;
...
class Processor
{
    ...
    public static function process(
        ...
        //\OpenDxp\Bundle\CoreBundle\Controller\PublicServicesController::thumbnailAction()
        ...
        if ($fileExists === false) {
            ...
            $lock = OpenDxp::getContainer()->get(LockFactory::class)->createLock($lockKey);
            ...
            if (!$storage->fileExists($storagePath)) {
                ...
                $isImageOptimizersEnabled = OpenDxpConfig::getSystemConfiguration('assets')['image']['thumbnails']['image_optimizers']['enabled'];
