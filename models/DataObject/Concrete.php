...
class Concrete extends DataObject implements LazyLoadedFieldsInterface
{
    ...
    protected function update(?bool $isUpdate = null, array $params = []): void
    {
        ...
        OpenDxp::getEventDispatcher()->dispatch($preUpdateEvent, DataObjectEvents::PRE_UPDATE_VALIDATION_EXCEPTION);
    ...
    public function saveVersion(bool $setModificationDate = true, bool $saveOnlyVersion = true, ?string $versionNote = null, bool $isAutoSave = false): ?Model\Version
    {
        try {
            ...
            if ($saveOnlyVersion) {
                ...
                OpenDxp::getEventDispatcher()->dispatch($preUpdateEvent, DataObjectEvents::PRE_UPDATE);
            }
            ...
            if ($saveOnlyVersion) {
                ...
                OpenDxp::getEventDispatcher()->dispatch($postUpdateEvent, DataObjectEvents::POST_UPDATE);
            }
            ...
            OpenDxp::getEventDispatcher()->dispatch($postUpdateFailureEvent, DataObjectEvents::POST_UPDATE_FAILURE);
