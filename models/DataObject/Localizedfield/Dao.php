 ...
 * @internal
 *
 * @property \OpenDxp\Model\DataObject\Localizedfield $model
 */
class Dao extends Model\Dao\AbstractDao
{
    ...
    public function save(array $params = []): void
    {
        ...
        // see OpenDxp\Model\DataObject\Fieldcollection\Dao::delete

        $forceUpdate = false;
        if (
            (isset($params['newParent']) && $params['newParent']) ||
            DataObject::isDirtyDetectionDisabled() ||
            $this->model->hasDirtyLanguages() ||
        ...
        $ignoreLocalizedQueryFallback = \OpenDxp\Config::getSystemConfiguration('objects')['ignore_localized_query_fallback'];
