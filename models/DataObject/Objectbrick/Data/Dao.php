 ...
 * @internal
 *
 * @property \OpenDxp\Model\DataObject\Objectbrick\Data\AbstractData $model
 */
class Dao extends Model\Dao\AbstractDao
{
    ...
    {
        // HACK: set the opendxp admin mode to false to get the inherited values from parent if this source one is empty
            ...
            foreach ($fieldDefinitions as $fieldName => $fd) {
                ...
                if ($fd instanceof ResourcePersistenceAwareInterface) {
                    $fieldDefinitionParams = [
                        'owner' => $this->model, //\OpenDxp\Model\DataObject\Objectbrick\Data\Dao
                        'fieldname' => $fieldName,
