...
class Area extends Model\Document\Editable
{
    ...
    public function frontend(): void
    {
        ...
        $editableHandler = OpenDxp::getContainer()->get(EditableHandler::class);
        ...
        if ($dialogConfig) {
            ...
            $this->outputEditmode('<div class="opendxp_area_dialog" data-name="' . $attributes['data-name'] . '" data-real-name="' . $attributes['data-real-name'] . '" ' . $dialogAttributes . '></div>');
        }
