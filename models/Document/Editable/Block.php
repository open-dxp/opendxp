...
class Block extends Model\Document\Editable implements BlockInterface
{
    ...
    public function blockControls(bool $return = false)
    {
        ...
        $html = <<<EOT
<div class="opendxp_block_buttons" $attr>
    <div class="opendxp_block_amount" $attr></div>
    <div class="opendxp_block_plus" $attr></div>
    <div class="opendxp_block_minus" $attr></div>
    <div class="opendxp_block_up" $attr></div>
    <div class="opendxp_block_down" $attr></div>
    <div class="opendxp_block_clear" $attr></div>
</div>
EOT;
