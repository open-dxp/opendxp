...
abstract class PageSnippet extends Model\Document
{
    ...
    public function saveVersion(bool $setModificationDate = true, bool $saveOnlyVersion = true, ?string $versionNote = null, bool $isAutoSave = false): ?Model\Version
    {
        try {
            ...
            if ($saveOnlyVersion) {
                ...
                OpenDxp::getEventDispatcher()->dispatch($preUpdateEvent, DocumentEvents::PRE_UPDATE);
            }
            ...
            if ($saveOnlyVersion) {
                ...
                OpenDxp::getEventDispatcher()->dispatch($postUpdateEvent, DocumentEvents::POST_UPDATE);
            }
            ...
            OpenDxp::getEventDispatcher()->dispatch($postUpdateFailureEvent, DocumentEvents::POST_UPDATE_FAILURE);
    ...
    public function getController(): ?string
    {
        if (empty($this->controller)) {
            $this->controller = OpenDxp::getContainer()->getParameter('opendxp.documents.default_controller');
        }
    ...
    protected function checkMissingRequiredEditable(): void
    {
        ...
        if ($this->getMissingRequiredEditable() === null) {
            ...
            $editableUsageResolver = OpenDxp::getContainer()->get(EditableUsageResolver::class);
