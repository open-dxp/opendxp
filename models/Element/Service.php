...
class Service extends Model\AbstractModel
{
    ...
    public static function renewReferences(mixed $data, bool $initial = true, ?string $key = null): mixed
    {
        ...
        if (is_object($data)) {
            ...
            if ($data instanceof ElementInterface && !DataObject\AbstractObject::doNotRestoreKeyAndPath()) {
                ...
                if ($originalElement) {
                    //do not override filename for Assets
    ...
    public static function getValidKey(string $key, string $type): string
    {
        ...
        OpenDxp::getEventDispatcher()->dispatch($event, SystemEvents::SERVICE_PRE_GET_VALID_KEY);
    ...
    public static function cloneMe(ElementInterface $element): ElementInterface
    {
        ...
        if ($element instanceof Concrete) {
            $deepCopy->addFilter(
                ...
                new OpenDxpClassDefinitionMatcher(Data\CustomDataCopyInterface::class)
            );
        }
    ...
    public static function getNoteData(Note $note): array
    {
        ...
        $e = [
            ...
            'cpath' => $cpath,
            'date' => $note->getDate(),
            'title' => OpenDxp::getContainer()->get(TranslatorInterface::class)->trans($note->getTitle(), [], 'admin'),
            ...
            if ($data) {
                ...
                if ($element instanceof Concrete) {
                    $copier->addFilter(
                        ...
                        new OpenDxpClassDefinitionMatcher(Data\CustomVersionMarshalInterface::class)
                    );
                }
    ...
    public static function getDeepCopyInstance(mixed $element, ?array $context = []): DeepCopy
    {
        ...
        OpenDxp::getEventDispatcher()->dispatch($event, SystemEvents::SERVICE_PRE_GET_DEEP_COPY);
