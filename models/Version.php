...
use Exception;
use OpenDxp;
use OpenDxp\Event\Model\VersionEvent;
use OpenDxp\Event\Traits\RecursionBlockingEventDispatchHelperTrait;
use OpenDxp\Event\VersionEvents;
use OpenDxp\Logger;
...
/**
 * @method \OpenDxp\Model\Version\Dao getDao()
 */
final class Version extends AbstractModel
{
    ...
    {
        $this->storageAdapter = OpenDxp::getContainer()->get(VersionStorageAdapterInterface::class);
    }
