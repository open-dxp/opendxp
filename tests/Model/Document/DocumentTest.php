...
class DocumentTest extends ModelTestCase
{
    ...
    public function testCustomModificationDate(): void
    {
        ...
        $currentTime = time();
        $document = \OpenDxp\Model\Document::getById($document->getId(), ['force' => true]);
        $document->save();
    ...
    public function testEmail(): void
    {
        ...
        $emailDocument = TestHelper::createEmptyDocument('', true, true, '\\OpenDxp\\Model\\Document\\Email');
    ...
    public function testLink(): void
    {
        ...
        $linkDocument = TestHelper::createEmptyDocument('', true, true, '\\OpenDxp\\Model\\Document\\Link');
